...
@hook.command("gb", "gelbooru", autohelp=False)
def gelbooru(text, reply):
    ...
    reply("\x02[{}]\x02 Score: \x02{}\x02 - Rating: {} - {}".format(id, score, rating, url))
    # return u'\x02[{}]\x02 Score: \x02{}\x02 - Rating: {} - {} - {}'.format(id, score, rating, url, tags[:75].strip())



gelbooru_list_re = re.compile(r'(.+gelbooru.com/.+list&tags.+)', re.I)
...
gelbooru_re = re.compile(r'(?:gelbooru.com.*?id=)([-_a-zA-Z0-9]+)', re.I)
